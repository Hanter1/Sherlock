...
object AppInfo {
    ...
    fun aboutText(context: Context): String {
        ...
        return buildString {
            ...
            appendLine("Только открытые источники. Закрытые базы не подключены.")
            appendLine("Публичный поиск может показать ФИО/упоминания/следы утечек, уже попавшие в индекс.")
